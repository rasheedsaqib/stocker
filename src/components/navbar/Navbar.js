const Navbar = () => {
    return (
        <div style={{width: '100%'}}>
            <div className='width'>
                <nav
                    className="navbar navbar-expand-lg navbar-inner fixed-top custom-nav sticky w-100 rounded-0 mb-0">
                    ...
                    <div className="container"><a href="#" className="navbar-brand brand-logo mr-4 logo">Stocker</a>
                        <div id="navbarCollapse" className="navbar-collapse collapse justify-content-end mr-3">
                            <ul className="navbar-nav navbar-center">
                                ...
                                <li className="nav-item dropdown"><a data-toggle="dropdown"
                        ...
                        <button className="btn text-white border" type="submit">Contact</button>
                    </div>
                </nav>
            </div>
        </div>
